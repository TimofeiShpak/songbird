    ...
    [
        {
            ...
            description: 'Эта самая большая нелетающая птица населяет обширные территории африканского континента, при этом африканские страусы прекрасно себя чувствуют в условиях неволи.'
        },
        {
            id: 2,
            name: 'Горный гусь',
            ...
            description: 'Благодаря своему оперению, этот вид легко распознается. Практически все туловище Горного гуся покрыто светло-серыми перьями, только подгрудок и подхвостье – белое.'  
        },
        {
            id: 3,
            name: 'Древесная утка',
            ...
            description: 'Древесные утки (Dendrocygna) обладают промежуточными характеристиками между утками и гусями: своим телосложением они напоминают уток, а длинными ногами и шеей, а также широкими тупыми крыльями - гусей.'   
        },
        {
            id: 4,
            name: 'Огарь',
            ...
            description: 'Огарь — это яркая и своеобразная красная водоплавающая утка, гнездящаяся на юго-востоке Европы и в Средней Азии, мигрирующая на зиму в Южную Азию.'   
        },
        {
            id: 5,
            name: 'Кряква',
            ...
            description: 'Кряква — очень известная и многочисленная популяция уток на планете. Ее можно увидеть практически в любом водоеме.'
        },
        {
            id: 6,
            ...
            description: 'Морская чернеть - довольно крупный нырок плотного телосложения. Туловище широкое. Шея короткая, голова относительно крупная, округлая.'  
        },
    ],
    [
        {   
            ...
            description: 'Лебедь-кликун – один из видов лебедей, величественных птиц семейства утиных. Место обитания Обитает эта птица на обширной территории – от Скандинавии до Чукотки.'
        },
        {
            id: 2,
            name: 'Мускусная утка',
            ...
            description: 'В последнее время индоутка стала одной из самых востребованных птиц в домашнем хозяйстве и фермерской деятельности.'
        }, 
        {
            id: 3,
            name: 'Серый гусь',
        ...
        },
        {
            ...
            description: 'Белошейная или тихоокеанская гагара (Gavia pacifica) летом внешне очень похожа на чернозобую гагару, отличаясь от нее только немного меньшими размерами и наличием белого оперения внизу шеи.'
        },
        {
            id: 5,
            ...
            description: 'Характерные особенности этого вида: светлый, короткий и толстый клюв с темной поперечной полосой, короткая плюсна и отсутствие на голове каких-либо украшающих перьев.'
        },
        {
            id: 6,
            ...
            description: 'Пеликаны — очень крупные водоплавающие птицы. Кудрявый пеликан может достичь самых крупных размеров. Это делает его одной из самых больших и тяжелых летающих птиц.'
        }
    ],
    [
        {   
            ...
            description: 'Белоглазый нырок (Aythya nyroca) - небольшая, немного крупнее чирка, утка весом от 0,4 до 0,65 кг. Во внешности самца наиболее примечательны красивая каштаново-коричневая окраска.'
        },
        {
            id: 2,
            name: 'Мандаринка',
            ...
            description: 'Утка-мандаринка – один из самых эффектных представителей фауны. Неповторимая внешность и удивительная верность партнёру сделала птицу символом семейного счастья в Китае.'
        }, 
        {
            id: 3,
            ...
            description: 'Мраморный чирок является компактной интересной птицей, принадлежащей к семейству Утиные. Изящное создание выгодно выделяется на водной глади, чем привлекает внимание туристов и охотников.'
        },
        {
            id: 4,
            name: 'Чёрная казарка',
            ...
            description: 'Чёрная казарка (Branta bernicla) — водоплавающая птица семейства утиных и самый мелкий представитель рода казарок.'
        },
        {
            id: 5,
            name: 'Сухонос',
            ...
            description: 'Сухонос (лат. Anser cygnoides) — водоплавающая птица семейства утиных. Сухонос — крупный гусь размером с домашнего гуся, внешне напоминающий гуменника.'
        },
        {
            id: 6,
            name: 'Священный ибис',
            ...
            description: 'Священный ибис (лат. Threskiornis aethiopicus) — птица из семейства ибисовых. Название своё получил потому, что был священной птицей в древнем Египте.'
        }
    ],
    [
        {
            ...
            description: 'Для нее характерен внешний вид водоплавающих птиц. Несколько превосходит размерами домашнюю утку. Имеет продолговатое тело и короткие узкие крылья.'
        },
        {
            id: 2,
            ...
            description: 'Смеющийся сокол относится к семейству соколиных и образует единственный вид  в роду смеющиеся соколы. Смеющийся сокол издаёт крики, похожие на хохот человека, вследствие чего и получила название.'  
        },
        {
            id: 3,
            ...
            description: 'Овсянка – это небольшая птица семейства воробьиных, выделяющаяся среди прочих пернатых ярко-желтой окраской грудки и головки.'
        },
        {
            id: 4,
            ...
            description: 'Кукушка – это одна из самых известных птиц, типичный обитатель лесов, парков, частый гость на садовых участках. Ее характерное «ку-ку» почти невозможно спутать с другими голосами зверей и птиц.'  
        },
        {
            id: 5,
            ...
            description: 'Гриф – самый крупный хищник, парящий в воздухе. У многих при упоминании этой птицы возникает неприязненное ощущение, ведь меню грифа состоит из падали.' 
        },
        {
            id: 6,
            name: 'Чёрная база',
            ...
            description: 'База – хищная птица средних размеров. Длина ее тела находится в пределах от 38 до 45 см, масса составляет 220 – 300 г, размах крыльев от 85 до 95 см.'  
        },
    ],
    [
        {
            ...
            description: 'Глухарь величественная птица, в которой чувствуется сила и основательность. Красивый окрас перьев, поднятый вверх клюв, напоминающий веер пышный хвост невольно заставляют любоваться пернатым.'  
        },
        {
            id: 2,
            name: 'Вальдшнеп',
            ...
            description: 'Такая необычная птица, как вальдшнеп, нередко упоминалась в различных художественных произведениях. Стоит только вспомнить «Записки охотника» И.С. Тургенева.' 
        },
        {
            id: 3,
            ...
            description: 'Ястребиная сова — это небольшая птица, размером чуть крупнее голубя. Длина ее тела от 36 до 41 см, размах крыльев составляет 71-81 см, вес находится в пределах от 220 до 400 г.'   
        },
        {
            id: 4,
            name: 'Удод',
            ...
            description: 'Удод (от латинского Upupa epops) – это птица, единственный современный представитель из семейства удодовых отряда ракшеобразных. Некрупная птица, с длинной тела 25-28 см и весом до 75 г.'  
        },
        {
            id: 5,
            name: 'Тетерев',
            ...
            description: 'Тетерев является одной из самых любимых птиц в народе. Его ценят за нежные детские воспоминания о многочисленных сказках, за яркую и запоминающуюся внешность.'  
        },
        {
            id: 6,
            name: 'Филин',
            ...
            description: 'Выразительная птица поражает величием, суровым видом. Филина боятся многие обитатели леса. Человек тоже наделил хищника сверхспособностями – в легендах они олицетворяют темные силы.'  
        },
    ],
    [
        {
            ...
            description: 'Африканская циккаба длиной от 30 до 35 см. Перьевые ушки отсутствуют. Окраска оперения, в основном, коричневая. На верхней части тела имеются белые крапины.'
        },
        {
            id: 2,
            ...
            description: 'Уздечковый африканский трогон длиной 33 см. Оперение верхней стороны металлически-зелёное, брюхо и гузка пурпурного цвета, крылья серые с чёрно-белыми полосами.'
        },
        {
            id: 3,
            ...
            description: 'Африканский широкорот величиной примерно 29—30 см. Верхняя и нижняя части тела, а также голова имеют окраску от коричневатого до каштанового цвета, грудь имеет фиолетовый оттенок.'  
        },
        {
            id: 4,
            ...
            description: 'Карликовый зимородок длиной 13 см и весом 18 г. У него короткий хвост и длинный клюв. Верхняя часть тела оливково-зелёная, нижняя часть тела оранжево-красная, середина брюха белая.'  
        },
        {
            id: 5,
            ...
            description: 'Африканский серый токо[1], или серый токо[2][3], или африканский серый ток[4] (лат. Tockus nasutus) — один из видов птиц-носорогов из рода токов.'   
        },
        {
            id: 6,
            ...
            description: 'Африканский белохохлый калао[1] (лат. Tropicranus albocristatus) — один из видов птиц-носорогов (семейство Bucerotidae), обитающий во влажных лесах Центральной и Западной Африки.' 
        },
    ]
]
